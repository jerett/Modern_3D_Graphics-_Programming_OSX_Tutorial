...
Render(GLFWwindow *window)
{
    ...
    glUniform3f(offset_location, 0, 0, 0.5);
    glDrawElements(GL_TRIANGLES, sizeof(index_data), GL_UNSIGNED_SHORT, 0);

    glUniform3f(offset_location, 0, 0, -1);
    glDrawElementsBaseVertex(GL_TRIANGLES, sizeof(index_data), GL_UNSIGNED_SHORT, 0, num_count);
    glBindVertexArray(0);
