...
initProgram()
{
    ...
    shaders.push_back(Framework::CreateShader(GL_VERTEX_SHADER, "vertexPosition.vert"));
    shaders.push_back(Framework::CreateShader(GL_FRAGMENT_SHADER, "vertexPosition.frag"));
